...
## 4. Typical Targets
Although anyone with an internet connection can be a potential target, data shows that certain groups are particularly affected. This includes LGBTQ+ youth, neurodivergent individuals and those who speak out on sensitive social issues. However, most cases are arbitrary, trigerred usually by a single misunderstood comment.
## 5. Consequences
The fallout of cyberbullying is often devastating:
* **Psychological:** Clinical depression, severe anxiety and even loss of self-exteem.
